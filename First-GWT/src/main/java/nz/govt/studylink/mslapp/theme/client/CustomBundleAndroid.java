...
public interface CustomBundleAndroid extends ClientBundle, CustomClientBundle {
	...
	// Override the Android progress indicator with ios style because of our background color
	@Source({ "com/googlecode/mgwt/ui/client/theme/base/css/progressindicator.css", "com/googlecode/mgwt/ui/client/theme/base/css/android/progressindicator.css", "css/progressindicator.css", "com/googlecode/mgwt/ui/client/theme/base/css/iphone/progressindicator.css" })
	ProgressIndicatorCss getProgressIndicatorCss();

	// Override the android head css to fix the issue that the head title position is not in the center in android style
	...
	@Source({ "com/googlecode/mgwt/ui/client/theme/base/css/list.css", 
		"com/googlecode/mgwt/ui/client/theme/base/css/android/list.css", 
		"css/list.css" })
	ListCss getListCss();
