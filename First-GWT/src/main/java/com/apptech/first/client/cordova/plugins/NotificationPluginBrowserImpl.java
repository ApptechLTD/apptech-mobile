...
public class NotificationPluginBrowserImpl extends BaseNotificationPlugin{
	...
	private native void registerDeviceImpl(JavaScriptObject pushNotification, boolean alertParamter, boolean badgeParamter,
		...
		this.@com.apptech.first.client.cordova.plugins.NotificationPluginBrowserImpl::handleOnRegisterDeviceSuccess(Lcom/google/gwt/core/client/JavaScriptObject;)(status);
	}-*/;
	...
	private native void init()/*-{
		...
		$wnd.mslapp.notificationCallback = function(notification){
			that.@com.apptech.first.client.cordova.plugins.BaseNotificationPlugin::handleOnPushNotification(Lcom/google/gwt/core/client/JavaScriptObject;)(notification);
		};
	}-*/;
}
