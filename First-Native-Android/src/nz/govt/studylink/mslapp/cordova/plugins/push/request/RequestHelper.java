...
//
// MIT Licensed
package nz.govt.studylink.mslapp.cordova.plugins.push.request;

import android.content.Context;
import android.location.Location;

import nz.govt.studylink.mslapp.cordova.plugins.push.data.PushZoneLocation;
import nz.govt.studylink.mslapp.cordova.plugins.push.request.versions.VersionHelper;
import nz.govt.studylink.mslapp.cordova.plugins.push.request.versions.Version__1_2;
import nz.govt.studylink.mslapp.cordova.plugins.push.request.versions.Version__1_3;
...
public class RequestHelper
{
	...
	private static VersionHelper getVersionHelper(String pushVersion)
	{
		...
		{
			throw new RuntimeException("No Version Request Helper sent to version 鈩� + pushVersion");
		}
