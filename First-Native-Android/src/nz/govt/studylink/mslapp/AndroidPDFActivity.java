...
public class AndroidPDFActivity extends Activity
{
	...
	private AsyncTask<String, Void, String> downloadPDFTask;
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		if (core == null) {
			...
			if (Intent.ACTION_VIEW.equals(intent.getAction())) {
				...
				downloadPDFTask = new AsyncTask<String, Void, String> () {
					...
					@Override
					protected void onPostExecute(String failString) {
						
						if (failString != null) {
							buffer = null;
							HandleDocument.androidPDFActivityHandler.onReadPdfFail("Unable to open the PDF!");
							return;
						}
						...
						HandleDocument.androidPDFActivityHandler.onReadPdfSuccessfully();
					}
			...
			mOutlineButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					if (outline != null) {
						...
						Intent intent = new Intent(AndroidPDFActivity.this, OutlineActivity.class);
